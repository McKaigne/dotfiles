...
(let* ((bg "#232a2e")
      ...
      (on-background "#859289")
      (on-err "#232a2e")
      (on-err-container "#f7d4d5")
      (on-primary "#232a2e")
      (on-primary-container "#e7eedd")
      (on-secondary "#232a2e")
      (on-secondary-container "#130f09")
      (on-surface "#859289")
      (on-surface-variant "#d3c6aa")
      (on-tertiary "#232a2e")
      (on-tertiary-container "#e4e7e5")
      (outline-color "#7a8478")
      (outline-variant "#555c54")
      (primary "#a7c080")
      (primary-container "#4e6924")
      (secondary "#d3c6aa")
      (secondary-container "#957736")
      (shadow "#475258")
      (surface "#232a2e")
      (surface-container "#2d353b")
      (surface-container-high "#363f47")
      (surface-container-highest "#3f4a52")
      (surface-container-low "#282f34")
      (surface-container-lowest "#252c30")
      (surface-variant "#2d353b")
      (tertiary "#9da9a0")
      (tertiary-container "#3a5a42")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#9da9a0")
      (on-success "#232a2e")
      (success-container "#3a5a42")
      (on-success-container "#e4e7e5")
      ;; Map fixed colors to regular colors
      (primary-fixed "#a7c080")
      (primary-fixed-dim "#4e6924")
      (secondary-fixed "#d3c6aa")
      (secondary-fixed-dim "#957736")
      (tertiary-fixed "#9da9a0")
      (tertiary-fixed-dim "#3a5a42")
      (on-primary-fixed "#232a2e")
      (on-primary-fixed-variant "#e7eedd")
      (on-secondary-fixed "#232a2e")
      (on-secondary-fixed-variant "#130f09")
      (on-tertiary-fixed "#232a2e")
      (on-tertiary-fixed-variant "#e4e7e5")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#859289")
      (inverse-primary "#a7c080")
      (inverse-surface "#232a2e")
